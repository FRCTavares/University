...
// Use calibrated gain value from illuminance model calibration
// This automatically adapts the controller to the specific LED-LDR characteristics
#define KP_BASE 28.0f // Base value for proportional gain
// KP is calculated at runtime based on: KP = KP_BASE * (1/calibratedGain)
extern float KP; // Actual proportional gain (calculated from calibration)

#define KI 1400.0f // Ganho integral
#define BETA 0.1f  // Fator de ponderação do setpoint (0-1)
...
#define SETPOINT_UNOCCUPIED 15.0 // iluminação em estado não-ocupado (lux)

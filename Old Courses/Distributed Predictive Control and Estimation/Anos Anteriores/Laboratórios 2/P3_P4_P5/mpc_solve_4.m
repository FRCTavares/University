% mpc_solve_4(x0, u_ss, Du_bar, H, R, A, B, C)
%
...
function u0 = mpc_solve_4(x0, u_ss, Du_bar, H, R, A, B, C)
    ...
    [U, ~, ~, ~] = quadprog(2 * M, 2 * x0' * PI' * W, [], [], [], [], lb, ub, x0, opts);

    Y_aux = W * U + PI * x0;
    U_aux = U;
    save('last_opt_4.mat', 'Y_aux', 'U_aux');

...
exportgraphics(gcf,['model_performance_training','.png'],'Resolution',300)
...
fprintf('N=%d ,MSE between propagated and measured output: %.4f\n',n,mse);

exportgraphics(gcf,['model_performance_validation','.png'],'Resolution',300)

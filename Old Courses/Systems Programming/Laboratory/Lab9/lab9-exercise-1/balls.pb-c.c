...
void ball_draw_display_msg__init(BallDrawDisplayMsg *message)
{
  static const BallDrawDisplayMsg init_value = BALL_DRAW_DISPLAY_MSG__INIT;
  *message = init_value;
}
size_t ball_draw_display_msg__get_packed_size(const BallDrawDisplayMsg *message)
{
  assert(message->base.descriptor == &ball_draw_display_msg__descriptor);
  return protobuf_c_message_get_packed_size((const ProtobufCMessage *)(message));
}
size_t ball_draw_display_msg__pack(const BallDrawDisplayMsg *message,
                                   uint8_t *out)
{
  assert(message->base.descriptor == &ball_draw_display_msg__descriptor);
  return protobuf_c_message_pack((const ProtobufCMessage *)message, out);
}
size_t ball_draw_display_msg__pack_to_buffer(const BallDrawDisplayMsg *message,
...
BallDrawDisplayMsg *
ball_draw_display_msg__unpack(ProtobufCAllocator *allocator,
                              size_t len,
                              const uint8_t *data)
{
...
void ball_draw_display_msg__free_unpacked(BallDrawDisplayMsg *message,
